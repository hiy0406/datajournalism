...
img=Image.open("C:/Users/hiy/Desktop/datajournalism/after10.png")
st.image(img, caption='2022-10-30 ~ 2022-12-8')

st.markdown("### 상권 지원 이후 현재까지의 워드클라우드")
img=Image.open("C:/Users/hiy/Desktop/datajournalism/after_support.png")
st.image(img, caption='2022-11-24~ 2022-12-8')

st.markdown("### 참사 이전 한 달간의 워드클라우드")
img=Image.open("C:/Users/hiy/Desktop/datajournalism/2022_10.png")
st.image(img, caption='2022-10-1 ~ 2022-10-28')

st.markdown("### 참사 이전, 코로나 기간 동안의 워드클라우드")
img=Image.open("C:/Users/hiy/Desktop/datajournalism/after_corona.png")
st.image(img, caption='2020-01-20 ~ 2022-10-28')

st.markdown("### 코로나 이전 기간의 워드클라우드")
img=Image.open("C:/Users/hiy/Desktop/datajournalism/before_corona.png")
...
youtube_comments = load_data("C:/Users/hiy/Desktop/datajournalism/youtube_result2.csv")
...
img=Image.open("C:/Users/hiy/Desktop/datajournalism/search1.png")
st.image(img)
img=Image.open("C:/Users/hiy/Desktop/datajournalism/search2.png")
st.image(img)

st.markdown("### 이태원 1동의 유동인구 및 매출 변화")
img=Image.open("C:/Users/hiy/Desktop/datajournalism/pop1.png")
st.image(img)
img=Image.open("C:/Users/hiy/Desktop/datajournalism/sales1.png")
st.image(img)

st.markdown("### 이태원 2동의 유동인구 및 매출 변화")
img=Image.open("C:/Users/hiy/Desktop/datajournalism/pop2.png")
st.image(img)
img=Image.open("C:/Users/hiy/Desktop/datajournalism/sales2.png")
st.image(img)
